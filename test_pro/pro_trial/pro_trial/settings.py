"""
Django settings for pro_trial project.
...
SECRET_KEY = 'ld4qu^hf&a7u15ve)i*jwbu&!x!lhj7771fu=8@sc^jt7wikq7'
...
WSGI_APPLICATION = 'pro_trial.wsgi.application'
